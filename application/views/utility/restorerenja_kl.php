...
<div class="container">
	<div><center><font size="4"><b />RESTORE DATA RENJA PER KL</font></center></div><br />
<div id="content">
...
//		}
		...
		if(substr($nama_file,6,2)!="KL")
		{
		echo '<center><font size="4" color="#FF0000">PERINGATAN !</font></center>';
		echo '<center><font size="4" color="#FF0000">"File Backup Salah, Bukan data Per KL '.$kode.' - '.$nama.'"</font></center>';
		return; 
		}
        if(substr($nama_file,9,3)!=$kode)
		{
		echo '<center><font size="4" color="#FF0000">PERINGATAN !</font></center>';
