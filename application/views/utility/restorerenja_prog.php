...
<div class="container">
	<div><center><font size="4"><b />RESTORE DATA RENJA PER PROGRAM</font></center></div><br />
<div id="content">
...
//		}
		...
		if(substr($nama_file,6,4)!="PROG")
		{
		echo '<center><font size="4" color="#FF0000">PERINGATAN !</font></center>';
		echo '<center><font size="4" color="#FF0000">"File Backup Salah, Bukan data Per Program '.$kode.' - '.$nama.'"</font></center>';
		return; 
		}
...
//			}
			...
			echo '<center><font size="4" color="#009900">" Data RENJA KL Per Program'.$kode.' - '.$nama.' Berhasil di Import "</font></center>';
