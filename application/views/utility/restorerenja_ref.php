...
<div class="container">
	<div><center><font size="4"><b />RESTORE DATA RENJA REF</font></center></div><br />
<div id="content">
...
//		}
		...
		if(substr($nama_file,6,3)!="ref")
		{
		echo '<center><font size="4" color="#FF0000">PERINGATAN !</font></center>';
		echo '<center><font size="4" color="#FF0000">"File Backup Salah, Bukan data Referensi '.$kode.' - '.$nama.'"</font></center>';
		return; 
		}
        if(substr($nama_file,10,3)!=$kode)
		{
		echo '<center><font size="4" color="#FF0000">PERINGATAN !</font></center>';
...
//			}
			...
			echo '<center><font size="4" color="#009900">" Data RENJA Per KL '.$kode.' - '.$nama.' Berhasil di Import "</font></center>';
