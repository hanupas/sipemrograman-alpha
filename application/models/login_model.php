...
public function validate($username,$password,$pcThang,$dskpd,$dunit)
{	
	$username1 = $username;
	$password1 = $password;
	$fskpd = $dskpd;
	$funit = $dunit;
	$query = $this->db->get_where('user', array('user_name' => $username1));
	$cek = $query->num_rows();
	if($cek != 0)
	{
    ...
    $client['kd_skpd'] = $fskpd;
    $client['esselon1'] = $funit;
