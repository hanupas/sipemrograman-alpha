...
//	$otori = $this->session->userdata('pcOtoriName');
	...
	b.akses AS show_menu FROM dyn_menu_renja a JOIN otori b ON a.id=b.menu_id WHERE b.user_id='$otori2' ORDER BY a.id "; 
	...
	b.akses AS show_menu FROM dyn_menu_renja a JOIN otori b ON a.id=b.menu_id WHERE a.id in ('1','2','3','4','5','30') ORDER BY a.id "; 
	$sq = "$sq1"; 
	//echo "<br />$sq<br />";
	$x = 1;
